...
const control = new LayerControl(
  [
    ...
    { id: 'shops-layer', name: 'Shops', description: 'Bike-related shops and services. Data from OpenStreetMap.', legendIcon: 'icons/shop.svg', initiallyVisible: initialVisible(urlState, 'shops-layer', false) },
